...
-- SUPER+M (exit) intentionally removed. Note that Hyprland still falls back to
-- a hardcoded SUPER+M exit bind if the config fails to load.
...
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("cliphist wipe; wl-copy --clear; wl-copy -p --clear"))
